...
--------------------------------------------------------- */
const API_BASE = "https://dresdenrp-bot.com";
...
--------------------------------------------------------- */
const C = {
  bg: "#151A21",       // stärkerer Blaustich als zuletzt, aber gedämpfter als das ursprüngliche kalte Blau
  panel: "#1C232C",
  panelAlt: "#242C37",
  border: "#323C49",
  text: "#E8EAED",
            ...
            <tbody>
              {filtered.map((t) => (
                <tr key={t.id}>
                  ...
                  <Td>{t.feedback_rating ? "⭐".repeat(t.feedback_rating) : <span style={{ color: C.muted }}>—</span>}</Td>
