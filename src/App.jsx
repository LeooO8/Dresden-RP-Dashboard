...
--------------------------------------------------------- */
const USERS = [
  { id: "1", name: "Finn_Ostwald", avatar: "F", role: "Owner", balance: 128450, status: "online", joined: "12.03.2023" },
  { id: "2", name: "Lea.Vance", avatar: "L", role: "Admin", balance: 54200, status: "online", joined: "02.05.2023" },
  { id: "3", name: "KaiRieper", avatar: "K", role: "Moderator", balance: 18990, status: "idle", joined: "19.07.2023" },
  { id: "4", name: "Mira_Halden", avatar: "M", role: "Fraktion: Polizei", balance: 9420, status: "offline", joined: "30.09.2023" },
  { id: "5", name: "Tobi.Krantz", avatar: "T", role: "Fraktion: EMS", balance: 7100, status: "online", joined: "14.01.2024" },
  { id: "6", name: "Noah_Fellner", avatar: "N", role: "Mitglied", balance: 2300, status: "offline", joined: "22.02.2024" },
];

const TRANSACTIONS = [
  { id: 1, from: "Finn_Ostwald", to: "Lea.Vance", amount: 5000, type: "Überweisung", time: "vor 12 Min" },
  { id: 2, from: "Bank", to: "Noah_Fellner", amount: 500, type: "Startguthaben", time: "vor 1 Std" },
  { id: 3, from: "Mira_Halden", to: "Shop", amount: 1200, type: "Kauf", time: "vor 2 Std" },
  { id: 4, from: "Tobi.Krantz", to: "Bank", amount: 800, type: "Einzahlung", time: "vor 3 Std" },
  { id: 5, from: "Bank", to: "KaiRieper", amount: 300, type: "Auszahlung", time: "vor 5 Std" },
];

const SHOP_ITEMS = [
  { id: 1, name: "Rolle: VIP Gold", category: "Rollen", price: 25000, sold: 14 },
  { id: 2, name: "Rolle: Fraktionsleitung", category: "Rollen", price: 60000, sold: 3 },
  { id: 3, name: "Funkgerät (virtuell)", category: "Gegenstände", price: 450, sold: 87 },
  { id: 4, name: "Sondernummernschild", category: "Gegenstände", price: 3200, sold: 22 },
  { id: 5, name: "Servername-Farbe", category: "Kosmetik", price: 1500, sold: 41 },
];

const DUTY = [
  { fraction: "Polizei", onDuty: 4, total: 12, hoursToday: 18.5 },
  { fraction: "EMS / Rettungsdienst", onDuty: 2, total: 8, hoursToday: 9.0 },
  { fraction: "Stadtverwaltung", onDuty: 1, total: 5, hoursToday: 3.5 },
  { fraction: "Mechaniker", onDuty: 0, total: 6, hoursToday: 0 },
];

const GIVEAWAYS = [
  { id: 1, prize: "VIP Gold Rolle", entries: 132, ends: "in 4 Std", status: "aktiv" },
  { id: 2, prize: "50.000 ₡", entries: 268, ends: "in 1 Tag", status: "aktiv" },
  { id: 3, prize: "Sondernummernschild", entries: 91, ends: "beendet", status: "beendet", winner: "Mira_Halden" },
];

const LOGS = [
  { id: 1, type: "bank", text: "Finn_Ostwald überwies 5.000 ₡ an Lea.Vance", time: "12:41" },
  { id: 2, type: "shop", text: "Mira_Halden kaufte 'Funkgerät (virtuell)'", time: "11:58" },
  { id: 3, type: "dienst", text: "Tobi.Krantz hat Dienst (EMS) begonnen", time: "11:20" },
  { id: 4, type: "login", text: "Lea.Vance hat sich über Discord OAuth2 angemeldet", time: "10:47" },
  { id: 5, type: "system", text: "Startguthaben auf 500 ₡ geändert von Finn_Ostwald", time: "09:15" },
  { id: 6, type: "bank", text: "Auszahlung von 300 ₡ an KaiRieper", time: "08:02" },
];
...
function Ticker({ overview }) {
  ...
  const items = [
    ...
    { label: "MITGLIEDER", value: overview ? overview.member_count.toLocaleString("de-DE") : "1.284", color: C.text },
    { label: "IM DIENST", value: overview ? overview.on_duty : "7", color: C.cyan },
    { label: "GESAMTGUTHABEN", value: fmtMoney(overview ? overview.total_balance : 2841600), color: C.gold },
  ...
  return (
    <>
      ...
      <div style={{ display: "flex", gap: 14, flexWrap: "wrap", marginBottom: 14 }}>
        <StatCard icon={Users} label="Mitglieder gesamt" value="1.284" delta="+18 heute" deltaUp accent={C.cyan} />
        <StatCard icon={ShieldHalf} label="Aktive Dienste" value="7" delta="+2" deltaUp accent={C.green} />
        <StatCard icon={Coins} label="Gesamtguthaben" value={fmtMoney(2841600)} delta="+3,1%" deltaUp accent={C.gold} />
        <StatCard icon={Activity} label="Bot-Uptime" value="99,97%" delta="14T 6H" deltaUp accent={C.text} />
      </div>
  ...
  return (
    <>
      ...
      <div style={{ display: "flex", gap: 14, flexWrap: "wrap", marginBottom: 20 }}>
        <StatCard icon={Wallet} label="Gesamtguthaben aller Nutzer" value={fmtMoney(2841600)} accent={C.gold} />
...
function StatsSection() {
  const bars = [40, 62, 55, 78, 70, 90, 84];
  const days = ["Mo", "Di", "Mi", "Do", "Fr", "Sa", "So"];
  return (
    <>
      <SectionTitle eyebrow="Auswertung" title="Statistiken" />
      <div style={{ display: "flex", gap: 14, flexWrap: "wrap", marginBottom: 18 }}>
        <StatCard icon={Users} label="Mitglieder" value="1.284" accent={C.cyan} />
        <StatCard icon={Activity} label="Aktive Nutzer (7T)" value="612" accent={C.green} />
        <StatCard icon={Coins} label="Gesamtvermögen" value={fmtMoney(2841600)} accent={C.gold} />
        <StatCard icon={ShoppingBag} label="Shop-Verkäufe" value="167" accent={C.cyan} />
        <StatCard icon={Clock} label="Dienststunden (heute)" value="31,0h" accent={C.green} />
        <StatCard icon={Gift} label="Giveaways gesamt" value="24" accent={C.gold} />
      </div>
